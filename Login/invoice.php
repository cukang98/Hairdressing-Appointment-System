...
function addAppintmentId( $libelle, $num )
{
    $r1  = $this->w - 80;
    $r2  = $r1 + 68;
    $y1  = 6;
...
function addClientAdresse( $adresse )
{
    ...
    $y1     = 40;
    $this->SetXY( $r1, $y1);
    $this->MultiCell( 62, 4, $adresse);
}

// Mode of payment
function addHairdresserName( $mode )
{
    $r1  = 10;
    $r2  = $r1 + 60;
    $y1  = 80;
    ...
    $this->SetFont( "Arial", "B", 10);
    $this->Cell(10,4, "HAIRDRESSER NAME", 0, 0, "C");
...
// Expiry date
function addAppointmentDate( $date )
{
    $r1  = 80;
    $r2  = $r1 + 40;
    $y1  = 80;
    ...
    $this->SetXY( $r1 + ($r2 - $r1)/2 - 5 , $y1+1 );
    $this->SetFont( "Arial", "B", 10);
    $this->Cell(10,4, "APPOINTMENT DATE", 0, 0, "C");
    $this->SetXY( $r1 + ($r2-$r1)/2 - 5 , $y1 + 5 );
    $this->SetFont( "Arial", "", 10);
    $this->Cell(10,5,$date, 0,0, "C");
}
...
function addCadreTVAs($finalpayment)
{
    ...
    $this->SetXY( $r1+8.5, $y1);
    $this->Cell(7,4, "Total Payment");
	$this->SetXY( $rl+15, $y1+11);
    $this->Cell(4,0, "RM : " .$finalpayment);
