								...
								if($customer)
								{
									...
									if($data != 0)
									{
										...
										while($row = mysqli_fetch_assoc($customer))
										{
											...
											echo'
											<td><a href=\'//localhost/Prototype/admin/viewcustomerprofile.php?custid='.$row["cust_id"].'\' title="View Profile"><img src="view.png" width="18px" style="margin-top:1px"></img></a> 
